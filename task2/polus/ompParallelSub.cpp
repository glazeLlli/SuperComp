...
#pragma omp single
		{
			string txtFileName("parallelInfo"), csvFileName("data");
			txtFileName += to_string(M) + " " + to_string(N) + " " + to_string(omp_get_num_threads()) + ".txt";
			csvFileName += to_string(M) + " " + to_string(N) + " " + to_string(omp_get_num_threads()) + ".csv";
